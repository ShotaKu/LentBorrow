...
class TradeScheduleActivity : Activity(), NavigationDrawerFragment.NavigationDrawerCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_trade_schedule)
    ...
    class PlaceholderFragment : Fragment() {
        ...
        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
            ...
            return inflater.inflate(R.layout.fragment_trade_schedule, container, false)
        }

        override fun onAttach(activity: Activity) {
            super.onAttach(activity)
            (activity as TradeScheduleActivity).onSectionAttached(
